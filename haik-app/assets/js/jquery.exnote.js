...
!function($){
	...
	var ExpansionNote = function(element, options) {
		...
		//set event
		$$
		.on("insert.exnote focus.exnote mousedown.exnote mouseup.exnote keydown.exnote keyup.exnote", function(){$$.exnote("getPos")})
		.on("keypress.exnote", function(e){$$.exnote("trigger", e)});
